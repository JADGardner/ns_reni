...
@dataclass
class SHSGPipelineConfig(VanillaPipelineConfig):
...
class SHSGPipeline(VanillaPipeline):
    ...
    def get_eval_loss_dict(self, step: int):
        ...
        """
        self.eval()
        # if we haven't already copied the the eval latents this step, do it now
        if self.last_step_of_eval_optimisation != step:
            if self.eval_equals_train:
