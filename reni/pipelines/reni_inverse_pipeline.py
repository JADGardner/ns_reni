...
@dataclass
class RENIInvesePipelineConfig(VanillaPipelineConfig):
    """Configuration for pipeline instantiation"""

    _target: Type = field(default_factory=lambda: RENIInversePipeline)
    """target class to instantiate"""


class RENIInversePipeline(VanillaPipeline):
    ...
    def __init__(
        self,
        config: RENIInvesePipelineConfig,
        device: str,
