...
@dataclass
class NerfactoRENIPipelineConfig(VanillaPipelineConfig):
    """Configuration for pipeline instantiation"""

    _target: Type = field(default_factory=lambda: NerfactoRENIPipeline)
    """target class to instantiate"""


class NerfactoRENIPipeline(VanillaPipeline):
    ...
    def __init__(
        self,
        config: NerfactoRENIPipelineConfig,
        device: str,
