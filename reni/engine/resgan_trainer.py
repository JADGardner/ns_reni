...
@dataclass
class RESGANTrainerConfig(TrainerConfig):
...
class RESGANTrainer(Trainer):
    ...
    def __init__(self, config: RESGANTrainerConfig, local_rank: int = 0, world_size: int = 1) -> None:
    ...
    def train_iteration(self, step: int) -> TRAIN_INTERATION_OUTPUT:
        ...
        # TODO This will need modification for GAN training
        # we do n steps of the discriminator for every step of the generator
        # and we need to optimise the discriminator first, then the generator
