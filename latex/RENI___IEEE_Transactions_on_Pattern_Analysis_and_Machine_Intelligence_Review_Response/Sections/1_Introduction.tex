...
We introduce a Rotation-Equivariant Natural Illumination (RENI++) model and make the following contributions:
\begin{itemize}[leftmargin=*]
...
\item[--] The first natural, outdoor HDR illumination prior based on neural fields.
